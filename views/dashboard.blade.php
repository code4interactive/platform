...
@section('content')
    <div class="row  border-bottom white-bg dashboard-header">
        ...
        <div class="col-sm-3">
            <h2>Welcome Amelia ęóąśłżźćń ĘÓĄŚŁŻŹĆŃ</h2>
                                    ...
                                    <div class="feed-activity-list">
                                        ...
                                        <div class="feed-element">
                                            <a href="profile.html" class="pull-left">
                                                <img alt="image" class="img-circle" src="/theme/images/profile.jpg">
                                            </a>
                                        ...
                                        <div class="feed-element">
                                            <a href="profile.html" class="pull-left">
                                                <img alt="image" class="img-circle" src="/theme/images/a2.jpg">
                                            </a>
                                            <div class="media-body ">
                                        ...
                                        <div class="feed-element">
                                            <a href="profile.html" class="pull-left">
                                                <img alt="image" class="img-circle" src="/theme/images/a3.jpg">
                                            </a>
                                            <div class="media-body ">
                                                <small class="pull-right">2h ago</small>
                                        ...
                                        <div class="feed-element">
                                            <a href="profile.html" class="pull-left">
                                                <img alt="image" class="img-circle" src="/theme/images/a4.jpg">
                                            </a>
                                            <div class="media-body ">
                                        ...
                                        <div class="feed-element">
                                            <a href="profile.html" class="pull-left">
                                                <img alt="image" class="img-circle" src="/theme/images/a5.jpg">
                                            </a>
                                            <div class="media-body ">
                                                <small class="pull-right">2h ago</small>
