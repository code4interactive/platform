...
<html lang="en-us">
	<head>
		...
		<link rel="stylesheet" type="text/css" media="screen" href="{{$platform['templatePath']}}/css/smartadmin-rtl.css"> -->
	...
	<body class="">
		...
		<header id="header">
			...
			<div class="pull-right">
				...
				<ul class="header-dropdown-list hidden-xs">
					<li>
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img alt="" src="{{$platform['templatePath']}}/img/flags/us.png"> <span> US </span> <i class="fa fa-angle-down"></i> </a>
						<ul class="dropdown-menu pull-right">
							<li class="active">
								<a href="javascript:void(0);"><img alt="" src="{{$platform['templatePath']}}/img/flags/us.png"> US</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img alt="" src="{{$platform['templatePath']}}/img/flags/es.png"> Spanish</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img alt="" src="{{$platform['templatePath']}}/img/flags/de.png"> German</a>
							</li>
						</ul>
					</li>
				</ul>
		...
		<aside id="left-panel">
			...
			<div class="login-info">
				<span> <!-- User image size is adjusted inside CSS, it should stay as it --> 
					<img src="{{$platform['templatePath']}}/img/avatars/sunny.png" alt="me" class="online" /> 
		...
		<script src="{{$platform['templatePath']}}/js/plugin/smartclick/smartclick.js"></script>
