					...
					<div class="widget-body widget-hide-overflow no-padding">
						...
						<div id="chat-container">
							...
							<div class="chat-list-body custom-scroll">
								<ul id="chat-users">
									<li>
										<a href="javascript:void(0);"><img src="{{$platform['templatePath']}}/img/avatars/5.png" alt="">Robin Berry <span class="badge badge-inverse">23</span><span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
									</li>
									<li>
										<a href="javascript:void(0);"><img src="{{$platform['templatePath']}}/img/avatars/male.png" alt="">Mark Zeukartech <span class="state"><i class="last-online pull-right">2hrs</i></span></a>
									</li>
									<li>
										<a href="javascript:void(0);"><img src="{{$platform['templatePath']}}/img/avatars/male.png" alt="">Belmain Dolson <span class="state"><i class="last-online pull-right">45m</i></span></a>
									</li>
									<li>
										<a href="javascript:void(0);"><img src="{{$platform['templatePath']}}/img/avatars/male.png" alt="">Galvitch Drewbery <span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
									</li>
									<li>
										<a href="javascript:void(0);"><img src="{{$platform['templatePath']}}/img/avatars/male.png" alt="">Sadi Orlaf <span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
									</li>
									<li>
										<a href="javascript:void(0);"><img src="{{$platform['templatePath']}}/img/avatars/male.png" alt="">Markus <span class="state"><i class="last-online pull-right">2m</i></span> </a>
									</li>
									<li>
										<a href="javascript:void(0);"><img src="{{$platform['templatePath']}}/img/avatars/sunny.png" alt="">Sunny <span class="state"><i class="last-online pull-right">2m</i></span> </a>
									</li>
									<li>
										<a href="javascript:void(0);"><img src="{{$platform['templatePath']}}/img/avatars/male.png" alt="">Denmark <span class="state"><i class="last-online pull-right">2m</i></span> </a>
									</li>
								</ul>
							</div>
						...
						<div id="chat-body" class="chat-body custom-scroll">
							<ul>
								<li class="message">
									<img src="{{$platform['templatePath']}}/img/avatars/5.png" class="online" alt="">
								...
								<li class="message">
									<img src="{{$platform['templatePath']}}/img/avatars/sunny.png" class="online" alt="">
									<div class="message-text">
										<time>
											2014-01-13
...
$(function () {
	...
	loadScript("{{$platform['templatePath']}}/js/plugin/flot/jquery.flot.cust.js", loadFlotResize);
	
	function loadFlotResize() {
	    loadScript("{{$platform['templatePath']}}/js/plugin/flot/jquery.flot.resize.js", loadFlotToolTip);
	}
	
	function loadFlotToolTip() {
	    loadScript("{{$platform['templatePath']}}/js/plugin/flot/jquery.flot.tooltip.js", generatePageGraphs);
	}
	...
	loadScript("{{$platform['templatePath']}}/js/plugin/vectormap/jquery-jvectormap-1.2.2.min.js", loadMapFile);
	
	// Load Map dependency 2 then rendeder Map
	function loadMapFile() {
	    loadScript("{{$platform['templatePath']}}/js/plugin/vectormap/jquery-jvectormap-world-mill-en.js", renderVectorMap);
	}
	...
	loadScript("{{$platform['templatePath']}}/js/plugin/fullcalendar/jquery.fullcalendar.min.js", setupCalendar);
