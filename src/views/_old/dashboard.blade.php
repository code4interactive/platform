...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Bob Doe's avatar" src="{{ $platform['assetsPath'] }}/assets/ace/avatars/user.jpg" />
    </div>
...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Joe Doe's avatar" src="{{ $platform['assetsPath'] }}/assets/ace/avatars/avatar2.png" />
    </div>
...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Jim Doe's avatar" src="{{ $platform['assetsPath'] }}/assets/ace/avatars/avatar.png" />
    </div>
...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Alex Doe's avatar" src="{{ $platform['assetsPath'] }}/assets/ace/avatars/avatar2.png" />
    </div>
...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Bob Doe's avatar" src="{{ $platform['assetsPath'] }}/assets/ace/avatars/avatar2.png" />
    </div>
...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Susan's avatar" src="{{ $platform['assetsPath'] }}/assets/ace/avatars/avatar3.png" />
    </div>
...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Phil Doe's avatar" src="{{ $platform['assetsPath'] }}/assets/ace/avatars/avatar4.png" />
    </div>
...
<div class="itemdiv memberdiv">
    <div class="user">
        <img alt="Alexa Doe's avatar" src="{{ $platform['assetsPath'] }}/assets/ace/avatars/avatar1.png" />
    </div>
...
<div id="comment-tab" class="tab-pane">
    <div class="comments">
        <div class="itemdiv commentdiv">
            <div class="user">
                <img alt="Bob Doe's Avatar" src="{{ $platform['assetsPath'] }}/assets/ace/avatars/avatar.png" />
            </div>
        ...
        <div class="itemdiv commentdiv">
            <div class="user">
                <img alt="Jennifer's Avatar" src="{{ $platform['assetsPath'] }}/assets/ace/avatars/avatar1.png" />
            </div>
        ...
        <div class="itemdiv commentdiv">
            <div class="user">
                <img alt="Joe's Avatar" src="{{ $platform['assetsPath'] }}/assets/ace/avatars/avatar2.png" />
            </div>
        ...
        <div class="itemdiv commentdiv">
            <div class="user">
                <img alt="Rita's Avatar" src="{{ $platform['assetsPath'] }}/assets/ace/avatars/avatar3.png" />
            </div>
            ...
            <div class="widget-main no-padding">
                <div class="dialogs">
                    <div class="itemdiv dialogdiv">
                        <div class="user">
                            <img alt="Alexa's Avatar" src="{{ $platform['assetsPath'] }}/assets/ace/avatars/avatar1.png" />
                        </div>
                    ...
                    <div class="itemdiv dialogdiv">
                        <div class="user">
                            <img alt="John's Avatar" src="{{ $platform['assetsPath'] }}/assets/ace/avatars/avatar.png" />
                        </div>
                    ...
                    <div class="itemdiv dialogdiv">
                        <div class="user">
                            <img alt="Bob's Avatar" src="{{ $platform['assetsPath'] }}/assets/ace/avatars/user.jpg" />
                        </div>
                    ...
                    <div class="itemdiv dialogdiv">
                        <div class="user">
                            <img alt="Jim's Avatar" src="{{ $platform['assetsPath'] }}/assets/ace/avatars/avatar4.png" />
                        </div>
